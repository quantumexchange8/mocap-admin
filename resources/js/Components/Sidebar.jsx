    ...
    <>
        <div className="" onClick={toggleSidebar}>
            <aside className={`fixed flex flex-col inset-y-0 z-20 overflow-auto border-r border-gray-200 bg-gray-100 
                ...
                <div className="flex flex-col items-center px-3 py-5 gap-6 flex-shrink-0">
                    <div className="flex flex-col items-stretch self-stretch gap-2">
                        <div className="flex-[1_0_0] text-xxs text-gray-500"> GENERAL </div>
                        <div className="flex flex-col items-center gap-1 self-stretch">
                            <div className={`${url === '/dashboard' ?'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm bg-gray-950' :'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm cursor-pointer hover:bg-gray-200'}`}>
                                <Dashboard color='currentColor' className={`${url === '/dashboard' ? 'text-white' : 'text-gray-950'}`}/>
                                <div className={`${url === '/dashboard' ? 'text-white text-sm' :'text-gray-950 text-sm'}`}> Dashboard </div>
                            </div>
                            <div className={`${url === '/' ?'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm bg-gray-950' :'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm cursor-pointer hover:bg-gray-200'}`}>
                                ...
                                <div className={`${url === '/' ? 'text-white text-sm' :'text-gray-950 text-sm'}`}> Requests </div>
                    ...
                    <div className="flex flex-col items-stretch self-stretch gap-2">
                        <div className="flex-[1_0_0] text-xxs text-gray-500"> EMPLOYEE </div>
                        <div className="flex flex-col items-center gap-1 self-stretch">
                            <div className={`${url === '/' ?'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm bg-gray-950' :'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm cursor-pointer hover:bg-gray-200'}`}>
                    ...
                    <div className="flex flex-col items-stretch self-stretch gap-2">
                        <div className="flex-[1_0_0] text-xxs text-gray-500"> DEPARTMENT </div>
                        <div className="flex flex-col items-center gap-1 self-stretch">
                            <div className={`${url === '/' ?'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm bg-gray-950' :'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm cursor-pointer hover:bg-gray-200'}`}>
                    ...
                    <div className="flex flex-col items-stretch self-stretch gap-2">
                        <div className="flex-[1_0_0] text-xxs text-gray-500"> WORK </div>
                        <div className="flex flex-col items-center gap-1 self-stretch">
                        <div className={`${url === '/' ?'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm bg-gray-950' :'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm cursor-pointer hover:bg-gray-200'}`}>
                    ...
                    <div className="flex flex-col items-stretch self-stretch gap-2">
                        <div className="flex-[1_0_0] text-xxs text-gray-500"> BENEFITS </div>
                        <div className="flex flex-col items-center gap-1 self-stretch">
                            <div className={`${url === '/' ?'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm bg-gray-950' :'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm cursor-pointer hover:bg-gray-200'}`}>
                    ...
                    <div className="flex flex-col items-stretch self-stretch gap-2">
                        <div className="flex-[1_0_0] text-xxs text-gray-500"> REWARDS </div>
                        <div className="flex flex-col items-center gap-1 self-stretch">
                            <div className={`${url === '/' ?'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm bg-gray-950' :'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm cursor-pointer hover:bg-gray-200'}`}>
                    ...
                    <div className="flex flex-col items-stretch self-stretch gap-2">
                        <div className="flex-[1_0_0] text-xxs text-gray-500"> COMPANY </div>
                        <div className="flex flex-col items-center gap-1 self-stretch">
                            <div className={`${url === '/' ?'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm bg-gray-950' :'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm cursor-pointer hover:bg-gray-200'}`}>
                    ...
                    <div className="flex flex-col items-stretch self-stretch gap-2">
                        <div className="flex-[1_0_0] text-xxs text-gray-500"> CONFIGURATION </div>
                        <div className="flex flex-col items-center gap-1 self-stretch">
                            <div className={`${url === '/' ?'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm bg-gray-950' :'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm cursor-pointer hover:bg-gray-200'}`}>
                    ...
                    <div className="flex flex-col items-stretch self-stretch gap-2">
                        <div className="flex-[1_0_0] text-xxs text-gray-500"> SYSTEM </div>
                            <div className="flex flex-col items-center gap-1 self-stretch">
                            <div className={`${url === '/' ?'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm bg-gray-950' :'flex items-center px-3 py-1.5 gap-3 self-stretch rounded-sm cursor-pointer hover:bg-gray-200'}`}>
