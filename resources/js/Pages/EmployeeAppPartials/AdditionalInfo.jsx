                ...
                <div className="flex flex-col gap-5 p-5">
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center justify-between">
                                <div className=""></div>
                                <InputError message={errors.investigate_remark} className="w-full max-w-[500px]" />
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center justify-between">
                                <div className=""></div>
                                <InputError message={errors.convicted_remark} className="w-full max-w-[500px]" />
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center justify-between">
                                <div className=""></div>
                                <InputError message={errors.bankrupt_remark} className="w-full max-w-[500px]" />
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center justify-between">
                                <div className=""></div>
                                <InputError message={errors.suspended_remark} className="w-full max-w-[500px]" />
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center justify-between">
                                <div className=""></div>
                                <InputError message={errors.directorship_remark} className="w-full max-w-[500px]" />
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center justify-between">
                                <div className=""></div>
                                <InputError message={errors.relative_remark} className="w-full max-w-[500px]" />
                            </div>
                        </div>
                    </div>
                </div>
