...
export default function MedicalInfo({ data, setData }) {
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <TextInput 
                                ...
                                disabled={data.medication_type === 'No' || data.gender === 'male'}
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="relative max-w-[220px]">
                            <Calendar 
                                ...
                                pt={{
                                    input: {
                                        className: 'py-3 px-4 text-sm text-gray-950 border border-gray-300 rounded-sm hover:border-gray-400 focus:border-gray-950 focus:ring-0 focus:outline-none'
                                    },
                                    panel: {
