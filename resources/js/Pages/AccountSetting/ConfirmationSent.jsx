    ...
    return (
        <div className="w-full">
            ...
            <div className="w-full flex flex-col items-center justify-center min-h-[90vh]">
                ...
                >
                    <div className="text-gray-950 text-xl font-bold">Your Request to Change Email Address is Verified!</div>
                    <div className="text-gray-700 text-base">Check Your New Email Address.</div>
                </motion.div>
            </div>
            {/* can add animation */}
