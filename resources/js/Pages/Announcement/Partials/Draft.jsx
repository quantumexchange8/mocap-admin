                            ...
                            getDraftAnnouncement.length > 0 ? (
                                <div className="p-5 flex flex-col xl:grid xl:grid-cols-2 gap-5 ">
                                    {
                                        getDraftAnnouncement.map((draft, index) => (
                                            <div key={index} className="p-5 flex flex-col gap-5 bg-white rounded-sm shadow-toast">
                                                            ...
                                                            <>
                                                                {
                                                                    draft.announcement_user && (
                                                                        <div className="flex items-center gap-1">
                                                                            {
                                                                                draft.announcement_user.map((ann_user, index) => (
                                                                                    <div key={index} className="flex items-center gap-1">
                                                                                        <span>{ann_user.user.name}{index !== draft.announcement_user.length - 1 && ','}</span>
                                                                                    </div>
                                                                                ))
                                                                            }
                                                                        </div>
                                ...
                                <div className="py-10 px-[200px] min-h-[80vh] flex flex-col items-center justify-center gap-3">
                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <div className="text-gray-700 text-sm">You don't have any saved drafts. Start drafting an announcement now and save it for later.</div>
                                    </div>
                                </div>
                            )
                        }
