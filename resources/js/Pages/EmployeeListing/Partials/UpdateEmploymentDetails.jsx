...
export default function UpdateEmploymentDetails({ fetchEmployee, employmentDetails, isOpenEmploymentDetail, setIsOpenEmploymentDetail, closeEmploymentDetails }) {
    ...
    const { data, setData, post, processing, errors, reset, isDirty } = useForm({
        ...
        employment_type: employmentDetails.employee_type || '',
        department_type: employmentDetails.department_id || '',
        position_type: employmentDetails.position || null,
        date_of_employment: employmentDetails.employee_date ? new Date(employmentDetails.employee_date) : null,
        intern_end_date: employmentDetails.employee_end_date ? new Date(employmentDetails.employee_end_date) : null,
    });
